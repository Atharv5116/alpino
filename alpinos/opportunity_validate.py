...
def validate_opportunity_alpinos(doc, method=None):
	...
	1. Sets customer_name from OBM's customer_business_name when opportunity_from == 'Offline Buyer Master'.
	2. Clears contact_person if ERPNext's map_fields() copied OBM's plain-text value into the
